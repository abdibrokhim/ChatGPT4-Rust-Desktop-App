...
export default function Home() {
  ...
  const [chatItems, setChatItems] = useState<ChatItemClas[]>([
    { content: 'Hello! I am ChatGPT, your AI assistant. How can I help you today?', isUser: false },
    { content: 'You can ask me anything or just say hi!', isUser: true}
  ]);
  ...
  const handleGenerate = () => {
    ...
    if (input) {
      setLoading(true);
      invoke<string>('get_completion', { prompt: input })
        .then(response => {
  ...
  const handleSubmit = (e: { preventDefault: () => void; }) => {
    ...
    if (!loading && input.trim() !== "") {
      setChatItems([...chatItems, { content: input, isUser: true }]);
      setInput("");
      if (base64) {
        handleGenerateImage();
      } else {
                ...
                <div className="flex flex-col w-full py-2 pl-3 flex-grow md:py-3 md:pl-4 relative border border-black/10 bg-white dark:border-gray-900/50 dark:text-dark text-dark dark:bg-gray-700 rounded-md shadow-[0_0_10px_rgba(0,0,0,0.10)] dark:shadow-[0_0_15px_rgba(0,0,0,0.10)]">
                  ...
                  >
                    {loading ? (
                      ...
                      <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24" className="icon-lg text-white dark:text-black"><path fill="currentColor" fillRule="evenodd" d="M12 3a1 1 0 0 1 .707.293l7 7a1 1 0 0 1-1.414 1.414L13 6.414V20a1 1 0 1 1-2 0V6.414l-5.293 5.293a1 1 0 0 1-1.414-1.414l7-7A1 1 0 0 1 12 3" clipRule="evenodd"></path></svg>
                    )}
                  </button>
                </div>
              </form>
